...
LES TROIS ORIGINES, lues sur le PRÉFIXE DE L'IDENTIFIANT :
...
PREFIXES: dict[str, str] = {"P-": ROBOT, "C-": ROBOT, "LEG-": IMPORT}
...
def pris_par_le_robot(trade_id: object) -> bool:
    """Vrai pour une ouverture décidée (`P-`) ou reconstituée d'un fill réel (`C-`)."""
