 ...
 */
// L'accueil est une destination explicite, pas une modale injectée dans les pages de
// travail : y revenir signifie demander à revoir le rideau. `session` le faisait
// disparaître après le premier passage de l'onglet et donnait l'impression d'une
// régression après déploiement — on ne voyait plus l'intro et on croyait l'avoir cassée.
export const INTRO_SESSION_POLICY: PolitiqueIntro = "always";
