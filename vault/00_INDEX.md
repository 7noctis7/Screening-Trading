...
## 📍 État actuel
**2026-07-02 (soir)** — **PAPER-READY, PAS LIVE-READY** (audit adverse). Scoring institutionnel recalibré sur le scope
assumé : **égal-pondéré 13,2/20 · pondéré-risque 13,7/20** (Data 15 · Risque 15 · Portefeuille 15 · ML 13 · Prod 11 ·
Exécution 10). 6 findings capital/vérité prouvés/retirés : **#4 idempotence Bitmart + #5 fills partiels = P0-SI-LIVE**
(bloquants avant tout broker réel) ; #1 Platt rétrogradé LOW (non-capital) ; #2/#6 retirés ; #3 reclassé dette.
Cœur data/backtest/risque solide, périphérie live-broker trouée ; filet alerting codé mais non branché. Cf.
`14_FULL_REVIEW.md` (audit adverse) + **ADR-0029** (long-only v1). **Ne pas engager de capital réel avant #4/#5.**

<details><summary>Historique (2026-07-02 — journal persistant)</summary>
