...
## Registre des hypothèses alt-data testées (2026-06) — 6 négatifs propres
...
| Cassure de canal (BTC) | placebo ✅ p=0,039 **mais** gate complet | ⏳ à valider DSR/PBO/sabotage (1 actif, tests multiples → p≈0,08) |
