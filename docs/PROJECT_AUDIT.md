...
| **Backtesting** | biais du survivant **NON MESURÉ** : les 7 délistés ingérés ne sont jamais entrés dans le top-30, le test ne mesure donc rien | **ouvert** |
...
- **L'ampleur du biais du survivant.**
